...
toggleButton.addEventListener('click', function() {
  ...
  menu.innerHTML = `
    ...
    <svg id="shut" xmlns='http://www.w3.org/2000/svg' width='100%' height='100%' style="position: absolute;"><line x1='0' y1='0' x2='100%' y2='350%' stroke='#121212' stroke-width='20%'/></svg>
  `;
  ...
  toggleButton.addEventListener("click", () =>  {
    main.innerHTML = `
    <p class="fade-in" style="font-size: 14px;margin-bottom:-50px;">Fivem Server</p>
    <h1 class="fade-in" style="letter-spacing: 3px;font-family: 'Roboto'">SERVER NAME</h1>
